...
\usepackage[colorlinks=true, linkcolor=purple2]{hyperref}
\usepackage{geometry}
...
\newcommand{\defin}[2]{
    ...
    \else 
        ...
        \begin{defi}
            ...
            %\normalfont
            \color{tanita}\fontfamily{txtt}\selectfont\textbf{{{#1}}:\hspace{5px}}
...
\newcommand{\note}[2]{
    ...
    \else 
        \color{rhoda}   
        %\begin{notes}
            \noindent Note\fontfamily{txtt}\selectfont{}#1:\hspace{5px}\normalfont\color{black}#2
...
\renewcommand{\thepropcount}{\arabic{section}.\arabic{propcount}}
\theoremstyle{plain}
...
\fancyfoot[C]{}
\fancyfoot[LO,RE]{\fontfamily{cmtt}\small\color{gray}J.Petermann: LogicNotes [V0.5.0-\today{ }at \DTMcurrenttime] }% old: \href[]{https://creativecommons.org/licenses/by-nc-nd/3.0/de/}{\color{gray}CC BY-NC-ND 3.0 DE}
