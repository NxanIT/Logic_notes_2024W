...
\fancyfoot[C]{}
\fancyfoot[LO,RE]{\fontfamily{cmtt}\small\color{gray}J.Petermann: LogicNotes [V0.2-\today] \href[]{https://creativecommons.org/licenses/by-nc-nd/3.0/de/}{\color{gray}CC BY-NC-ND 3.0 DE}}
...
\end{center}
\begin{center}
    \framebox[14cm]{Dieses Skript ist noch nicht vollständig und wird regelmäßig aktualisiert.}
\end{center}
