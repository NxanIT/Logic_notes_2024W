...
\prop{}{Suppose $s_1,s_2:V\to A$ agree on all variables that occur free in $\phi$ then 
 $$\mathcal{A}\models \varphi [s_1] \text{iff }\mathcal{A}\models \varphi [s_2]$$
    ...
    \begin{itemize}
        ...
        \[\begin{split}
            \mathcal{A}\models \forall x \varphi [s_1] &iff for all a\in A \mathcal{A}\models \varphi [s_1(x| a)]\\
            & iff for all a\in A \mathcal{A}\models \varphi [s_2(x| a)]\\
            & iff \mathcal{A}\models \forall x \varphi [s_2]
        \end{split}\]
    \end{itemize}
