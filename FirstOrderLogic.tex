...
\defin{substitutable}{\addAbbrev{SA}{substitutable}
        ...
        \item $(\forall y \varphi)'$\begin{itemize}
            ...
            \item[Case 2:] If $y$ does occur in $t$ and $x\neq y$. let $z$ be the variable that is the first variable that does not occur in $\varphi', x, t$ then set
                ...
                \begin{enumerate}
                    ...
                    Then $t$ is SA für $x$ in $\forall z (\varphi')^y_z$ iff $t$ is SA for $x$ in $(\varphi')^y_z$ because $x\neq z$.
...
\lemma{Substitution lemma}{If $t$ SA $x$ in $\varphi$ then $\mathcal{A}\models \varphi_t^x\: [s]$ iff $\mathcal{A}\models \varphi\: [s(x|\overline{s}(t))]$}{
    \begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{claimproof}
            \begin{itemize}
                ...
                Suppose $\mathcal{A}\vDash \forall x \varphi^* \: [s]$ then $\mathcal{A}\vDash \varphi^* \: [s(x|t)]$ for some $t$. By the substitution lemma (providet that $t$ is SA for $x$ in $\varphi$) we can replace $x$ by $t$ in the formula.
                ...
                If $t$ is not SA for $x$ in $\varphi$, we know that there exists a logically equivalent alphabetic variant $\varphi'$ of $\varphi$ such that $t$ is SA for $x$ in $\varphi'$.
            \end{itemize}
        \end{claimproof} 
