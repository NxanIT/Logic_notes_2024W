...
\defin{Language of PL}{The Language of Propositional logic is a set containing
    \begin{itemize}
...
Let $\{0,1\}$ be the set of truth values. A truth assignment (TA) for a set $S$ of prop. atoms is a map $\nu:S\to\{0,1\}$}
