...
\defin{Expression / prop. sentence}{An \imp{expression} is a any finite sequence of symbols
...
\lemma{}{No proper initial segment of a propositional sent. is itself a propositional sent.}{\label{NoPropIni}
    ...
    Let $PS = \text{set of all propositional sent.}$ and \\
    $PF = \text{set of propositional sent. s.t. no proper initial segment has \# left parenthesis = \# right parenthesis}$, 
