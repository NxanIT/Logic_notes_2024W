...
\bsp{}{
    ...
    (one element of $B$ cannot be generated in finitly many steps by other elements of $B$).
}
\defin{Freely generated set}{$C$ is freely generated from $B$ by $f,g$ if 
    \begin{itemize}
...
$\overline{h}\defeq \text{function w/ graph} \bigcup U$
