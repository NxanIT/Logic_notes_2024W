...
The sections \ref{mt:sec:LST} to \ref{MT:sec:NSA} are sourced from \cite[chapter~1]{EndertonHerbertB2001AMIt} and and the theory of o-minimality (from \ref{MT:sec:o-min} onwards) can be found in \cite{van1998tame}.
\section{Löwenheim-Skolem-Theorem}\label{mt:sec:LST}
